...
Route::controller(array('register','document','dashboard','attendee','user','message','project','tender','opportunity','search','activity','finance','hr','qc','warehouse','employee','requests','approval','category','content','ajax'));
