...
<div class="row">
    <div class="twelve columns">
        ...
        <fieldset>
            ...
            @endif
                @if( (($user['conventionPaymentStatus'] == 'pending' || $user['conventionPaymentStatus'] == 'paid' ) && ($type == 'convention')) || (($user['golfPaymentStatus'] == 'pending' || $user['golfPaymentStatus'] == 'paid') && ($type == 'golf')) )
